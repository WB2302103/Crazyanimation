                ...
                SizedBox(
                 ...
                 //     AnimatedContainer(
                   ...
                   //       ),
                      //  ),
                      //),
                   TopCard(menuClicked: menuClicked, defaultWidth: size.width*.44, dynamicWidth: size.width -42 -34 , defaultHeight:  size.width*0.65, dynamicHeight:size.width*1.1 -65 -34, colors: Colors.red, imageAsset:"assets/images/riha.png", replacementWidget: AnimatedOpacity(
                     duration:const Duration(milliseconds: 355),
                     curve: Curves.easeOut,
