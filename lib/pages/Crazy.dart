                     ...
                     //     TextSpan(
                      ...
                      //),
                        ...
                        AnimatedPositioned(
                         ...
                         child: TopCard(menuClicked: menuClicked, defaultWidth: size.width*.44, dynamicWidth: size.width*.12, defaultHeight: size.width*.43, dynamicHeight: size.width*.12, colors: Colors.grey, imageAsset:"assets/images/easin.png", replacementWidget:
                         AnimatedOpacity(
                           duration: const Duration(milliseconds: 355),
                           curve: Curves.easeOut,
                           opacity: menuClicked.value?1:0,
