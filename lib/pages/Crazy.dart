...
import 'package:untitled3/widgets/top_card.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Obx(()=>Stack(
                   children: [
                   TopCard(menuClicked: menuClicked, defaultWidth: size.width*.44 , dynamicWidth: size.width, defaultHeight: size.width*1.1, dynamicHeight: size.width*1.1, colors: Colors.black, imageAsset: "assets/images/rifayee.png", replacementWidget: const SizedBox()),
                 ...
                 //     AnimatedContainer(
                   //     duration:const Duration(milliseconds: 355),
                    ...
                    //      duration:const Duration(milliseconds: 355),
                     ...
                     //       borderRadius: BorderRadius.circular(100),
                      //      child: Image.asset("assets/images/rifayee.png",fit:
                        //    BoxFit.cover
                            //  ,),
                   //       ),
                      //  ),
                    ...
                    AnimatedPositioned(
                     ...
                     right: 0,
                      ...
                      child:   TopCard(menuClicked: menuClicked, defaultWidth: size.width*.44, dynamicWidth: size.width -42 -34 , defaultHeight:  size.width*0.65, dynamicHeight:size.width*1.1 -65 -34, colors: Colors.red, imageAsset:"assets/images/riha.png", replacementWidget: AnimatedOpacity(
                          duration:const Duration(milliseconds: 355),
                          curve: Curves.easeOut,
                   ...
                   //  child: Stack(
                      ...
                      AnimatedPositioned(
                        ...
                        child: TopCard(menuClicked: menuClicked, defaultWidth: size.width*.44, dynamicWidth: size.width*.12, defaultHeight: size.width*.43, dynamicHeight: size.width*.12, colors: Colors.grey, imageAsset: "assets/images/easin.png", replacementWidget: AnimatedOpacity(
                          opacity: menuClicked.value?1:0,
                          duration: const Duration(milliseconds: 355),
                          curve: Curves.easeOut,
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(100),
                            child: Image.asset("assets/images/easin.png",fit: BoxFit.cover,height: size.width*.12,width: size.width*.12,),
                          ),
                        )),
                      //  child: AnimatedContainer(
                      //    duration:const Duration(milliseconds: 355),
